...
int main(void) {
    ...
    int patientCount = importPatients("Data_files/patientData.txt", pets, MAX_PETS);
    int appointmentCount = importAppointments("Data_files/appointmentData.txt", appoints, MAX_APPOINTMENTS);
